...
(let ((black016 "#000000")   ;; black
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face       ((t (:foreground ,gray246 :weight bold))))
   `(font-lock-keyword-face       ((t (:foreground ,gray246 :weight bold))))
   `(font-lock-type-face          ((t (:foreground ,gray246 :weight bold))))
   ...
   ;; web-mode
   `(web-mode-html-tag-face          ((t (:foreground ,gray246 :weight bold))))
   `(web-mode-html-attr-name-face    ((t (:foreground ,gray246 ))))
   `(web-mode-css-property-name-face ((t (:foreground ,gray246 :weight bold))))
   `(web-mode-keyword-face           ((t (:foreground ,gray246 :weight bold))))
   `(web-mode-builtin-face           ((t (:foreground ,gray246 :weight bold))))
